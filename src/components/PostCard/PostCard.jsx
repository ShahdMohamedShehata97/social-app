...
export default function PostCard({ postInfo, queryKey }) {
  ...
  return (
    <Card className="full">
        ...
        <div>
          <Dropdown className="w-fit" isDisabled={isPending}>
            ...
            {userId === _id ? (
              ...
              <DropdownMenu aria-label="Static Actions">
                <DropdownItem key="copy" onClick={bookMark}>
                  <div className="flex items-center gap-1">
                    <CiBookmark />
                    <p>Save</p>
                  </div>
      ...
      <CardBody>
        {(body?.trim() || !isShare) && <div>
          <p>{body}</p>

         {bookmarked && <div className="bg-[#E7F3FF] text-[#1877f2] text-[11px] font-bold flex gap-1 justify-center items-center w-fit px-2 py-0.5 mt-6 rounded-2xl"> <CiBookmark size={13} />Saved</div>}
          ...
          <div className="flex gap-2 items-center">
            ...
            <p
              ...
              className={`text-[14px] font-semibold ${
                likesCount > 0
                  ? "text-[#62748e] cursor-pointer hover:underline"
            ...
            {openLikes && (
              <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
                <div className="bg-white w-[90%] md:w-[40%]  max-h-125 overflow-y-auto rounded-xl p-4">
      ...
      <CardFooter>
        <div
          className="flex justify-center md:justify-around w-full"
          onClick={() => {
            likeUnlike();
          }}
        >
          ...
          <button
            className={
              isLiked || likedPost
                ? "flex gap-2 items-center text-[#1877f2] cursor-pointer px-7 py-2 rounded-[10px]  bg-[#E7F3FF] "
                : "flex gap-2 items-center text-[#45556c] cursor-pointer px-7 py-2 rounded-[10px] hover:bg-[#F1F5F9] "
            }
          >
            <AiOutlineLike size={18} />
            <p className="text-[14px] font-semibold">Like</p>
