...
onSuccess:()=>{
  ...
  return (
   ...
   <div>
    ...
    <div className='min-h-screen'><div className="rounded-b-2xl h-75 bg-linear-to-r from-[#0f172a] via-[#1e293b] to-[#7fa1c3] relative w-full md:w-[85%]  mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                      <div className="flex items-center justify-between w-full">
                        <div className="relative group flex gap-3 items-center ">
                          ...
                          <p className='text-16px font-semibold text-[#62748e]'>{username}</p>
          ...
          {profilePosts.length !== 0 ? profilePosts.map((post)=>{return <div className="w-full md:w-[83%] mx-auto px-6 flex flex-col gap-5 mt-16">
                
                      <PostCard key={post.id} postInfo={post} queryKey={["getposts"]} />
                   
                </div>}):<div className="w-full md:w-[80%] mx-auto px-6 flex  gap-5 mt-4 bg-white py-3.5 mb-16 rounded-2xl justify-center">
